  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Riwayat Penyewaan", style: TextStyle(color: Colors.black)),
        leading: IconButton(
      ...
      body: Container(
        ...
        child: _isLoading
            ...
            : _riwayat.isEmpty
                ...
                : ListView.builder(
                    padding: const EdgeInsets.fromLTRB(15, 100, 15, 20), // Padding atas untuk AppBar transparan
                    itemCount: _riwayat.length,
                    itemBuilder: (context, index) {
                      final item = _riwayat[index];
                      return Card(
                        color: Colors.white.withOpacity(0.9), // Card sedikit transparan agar gradien terlihat
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _getStatusColor(item['status'] ?? 'Unknown').withOpacity(0.15),
