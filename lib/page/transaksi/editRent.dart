...
class _EditrentState extends State<Editrent> {
  ...
  void initState() {
    ...
    _namaPenyewaCtr = TextEditingController(text: widget.sewaData['nama_penyewa']);
    _lamaSewaCtr = TextEditingController(text: widget.sewaData['lama_sewa'].toString());
    _tanggalCtr = TextEditingController(text: widget.sewaData['tanggal_mulai']);
    
    try {
      _selectedDate = DateFormat('yyyy-MM-dd').parse(widget.sewaData['tanggal_mulai']);
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Edit Pesanan", style: TextStyle(color: Colors.black)),
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          padding: const EdgeInsets.fromLTRB(20, 100, 20, 20), // Padding atas disesuaikan
          child: Container(
            // Bungkus form dengan card putih semi-transparan agar terbaca
